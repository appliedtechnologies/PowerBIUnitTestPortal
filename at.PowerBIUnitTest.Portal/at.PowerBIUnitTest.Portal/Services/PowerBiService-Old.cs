...
{
    public class PowerBiServiceOld 
    {
        private readonly string clientId;
        private readonly string clientSecret;
        private readonly ILogger<PowerBiServiceOld> logger;
        
        public PowerBiServiceOld(IConfiguration config, ILogger<PowerBiServiceOld> logger){
